...
for ($x = 0; $x < count($persons); $x++){
    ...
    echo "<td class='results'><form action='editUserForm.php'><input type='hidden' name='id' value=".  $persons[$x]['userID']  ."><input type='submit' value='Edit'></form></td>";
    echo "<td class='results'><form action='../handlers/deleteUser.php'><input type='hidden' name='id' value=".  $persons[$x]['userID']  ."><input type='submit' value='Delete'></form></td>";
    ...
    echo "<td class='results'>" .$persons[$x]['username'] . "</td>";

    echo "<td class='results'>" .$persons[$x]['password'] . "</td>";
    echo "</tr>";
}
?>
</tbody>
